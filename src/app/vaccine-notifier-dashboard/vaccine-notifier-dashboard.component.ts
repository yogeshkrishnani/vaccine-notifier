...
export class VaccineNotifierDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.vaccineNotifierFormGroup = new FormGroup({
      ...
      includePaid: new FormControl(false, Validators.required),
  ...
  private handleResponse(res: any): void {
    ...
    const includePaid = this.vaccineNotifierFormGroup.get('includePaid').value;
    ...
    const centers = includePaid ? res.centers : res.centers.filter(center => center.fee_type === 'Free');
